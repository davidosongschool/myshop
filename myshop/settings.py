...
SECRET_KEY = 'u)np_hsw_a1x4n^!zrsvm4b@@q#tz2%ib5fc3g(ua!md74d@vp'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request', #Required by AllAuth - access HTTP Request object
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'static'),) #Set up directory for static files
